...
<div class="catalog">
<ul class="catalogbar">
  <li class="catalog-item "><a href="member_center.php">訂單查詢</a></li>
  <li class="catalog-item catalog-active"><a href="member_update.php">會員資料</a></li>
...
<div class="content" > 
	<form action="" method="POST" name="formJoin" id="formJoin" onSubmit="return checkForm();">
		...
		<div class="dataDiv">
            ...
            <span class="smalltext">若不修改密碼，請不要填寫。若要修改，請輸入密碼</span><span class="smalltext">二次。<br>若修改密碼，系統會自動登出，請用新密碼登入。</span><br/>
            <hr size="1" />
		</div>
            <h1>個人資料</h1>
		<div class="dataDiv">
           <label>真實姓名：</label>
            ...
            <span class="notice">*</span><br/><span class="smalltext">為西元格式(YYYY-MM-DD)。</span></p>
            <label>電子郵件：</label>
